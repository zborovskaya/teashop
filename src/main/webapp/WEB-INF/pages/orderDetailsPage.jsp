...
<jsp:useBean id="userInfo" type="by.zborovskaya.final_project.entity.UserInfo" scope="request"/>
<html>
...
<div class="page">
    ...
    <div class="container-fluid justify-content-center">
        <div class="text-center">
            ...
            <form action="/order/Overview">
                <button type="submit" class="btn btn-danger">Получить Word</button>
                <input name="command" value="getWordFile" type="hidden">
