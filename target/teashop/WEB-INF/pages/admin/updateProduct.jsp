...
<jsp:useBean id="product" type="by.zborovskaya.final_project.entity.Product" scope="request"/>
...
<div class="page">
    ...
    <c:if test="${not empty param.success}">
        <h4 style="text-align: center; color: green">
            Продукт обновлён успешно!
        </h4>
    </c:if>
    <div class="container justify-content-center col-12 col-sm-6 mt-3">
        <h3 class="text-center p-3">Обновить продукт</h3>
        <form role="form" action="${absolutePath}/products" method="post" class="needs-validation" novalidate>
            ...
            <div class="row gy-3">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="product_composition" class="form-control" value="${product.composition}" required
                           pattern=".{0,200}">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input type="time" name="product_time" value="${product.brewing_time}" class="form-control" required>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="temperature" value="${product.water_temperature}" class="form-control"
                ...
                <select class="form-select" name="product_category" required>
                    <c:forEach var="item" items="${applicationScope.categoryList}">
                        <c:if test="${product.category_id eq item.id}">
                            <option value="${item.id}" selected>${item.categoryName}</option>
                        </c:if>
                        <c:if test="${not (product.category_id eq item.id)}">
