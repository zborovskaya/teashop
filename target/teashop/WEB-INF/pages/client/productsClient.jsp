    ...
    <div class="row align-items-start">
        ...
        <div class="col">
            <form class="d-flex"
                ...
                <input class="form-control me-2" type="search" placeholder="Введите название продукта"
        ...
        <tr>
            ...
            <form action="/products" method="post">
                <td align="right">
                    <div class="col-md-4">
                        <input name="quantity"
                               value="${((not empty param.error) and item.id eq param.productId) ? param.quantity : 1}"
                               class="form-control"
                               type="number"
                               min="1"
                               max="100">
                    </div>
                    <c:if test="${not empty param.error and item.id eq param.productId}">
                        <div style=" color: red;">
                            Некорректно введено количество!
                        </div>
                    </c:if>
                </td>
                <td>
                    ...
                    <input name="category_id" value="${requestScope.category_id}" type="hidden">
                </td>
            </form>
        </tr>
    </c:forEach>
